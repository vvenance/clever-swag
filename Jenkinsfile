node {
    ...
    stage ('Build') {
        git url: 'https://github.com/vvenance/clever-swag.git'
    }
    ...
    stage ('Publish Static Doc') {
        withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'vvenancegithub',
                usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD']]) {
            git url: "https://$USERNAME:$PASSWORD@github.com/vvenance/api-doc",
            branch: 'master'
